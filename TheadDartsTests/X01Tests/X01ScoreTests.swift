...
class X01ScoreTests: XCTestCase {
    ...
    func testHitOneSingle() {
        ...
        XCTAssertEqual(x01Score.onePoints, 1)
    ...
    func testHitOneDouble() {
        ...
        XCTAssertEqual(x01Score.onePoints, 2)
    ...
    func testHitOneTriple() {
        ...
        XCTAssertEqual(x01Score.onePoints, 3)
    ...
    func testHitTwoSingle() {
        ...
        XCTAssertEqual(x01Score.twoPoints, 2)
        XCTAssertEqual(x01Score.points, 299)
    }
    ...
    func testHitTwoDouble() {
        ...
        XCTAssertEqual(x01Score.twoPoints, 4)
    ...
    func testHitTwoTriple() {
        ...
        XCTAssertEqual(x01Score.twoPoints, 6)
    ...
    func testHitThreeSingle() {
        ...
        XCTAssertEqual(x01Score.threePoints, 3)
        XCTAssertEqual(x01Score.points, 298)
    }
    ...
    func testHitThreeDouble() {
        ...
        XCTAssertEqual(x01Score.threePoints, 6)
        XCTAssertEqual(x01Score.points, 295)
    }
    ...
    func testHitThreeTriple() {
        ...
        XCTAssertEqual(x01Score.threePoints, 9)
    ...
    func testHitFourSingle() {
        ...
        XCTAssertEqual(x01Score.fourPoints, 4)
        XCTAssertEqual(x01Score.points, 297)
    }
    ...
    func testHitFourDouble() {
        ...
        XCTAssertEqual(x01Score.fourPoints, 8)
    ...
    func testHitFourTriple() {
        ...
        XCTAssertEqual(x01Score.fourPoints, 12)
    ...
    func testHitFiveSingle() {
        ...
        XCTAssertEqual(x01Score.fivePoints, 5)
    ...
    func testHitFiveDouble() {
        ...
        XCTAssertEqual(x01Score.fivePoints, 10)
    ...
    func testHitFiveTriple() {
        ...
        XCTAssertEqual(x01Score.fivePoints, 15)
    ...
    func testHitSixSingle() {
        ...
        XCTAssertEqual(x01Score.sixPoints, 6)
        XCTAssertEqual(x01Score.points, 295)
    }
    ...
    func testHitSixDouble() {
        ...
        XCTAssertEqual(x01Score.sixPoints, 12)
        XCTAssertEqual(x01Score.points, 289)
    }
    ...
    func testHitSixTriple() {
        ...
        XCTAssertEqual(x01Score.sixPoints, 18)
    ...
    func testHitSevenSingle() {
        ...
        XCTAssertEqual(x01Score.sevenPoints, 7)
    ...
    func testHitSevenDouble() {
        ...
        XCTAssertEqual(x01Score.sevenPoints, 14)
    ...
    func testHitSevenTriple() {
        ...
        XCTAssertEqual(x01Score.sevenPoints, 21)
    ...
    func testHitEightSingle() {
        ...
        XCTAssertEqual(x01Score.eightPoints, 8)
        XCTAssertEqual(x01Score.points, 293)
    }
    ...
    func testHitEightDouble() {
        ...
        XCTAssertEqual(x01Score.eightPoints, 16)
    ...
    func testHitEightTriple() {
        ...
        XCTAssertEqual(x01Score.eightPoints, 24)
    ...
    func testHitNineSingle() {
        ...
        XCTAssertEqual(x01Score.ninePoints, 9)
        XCTAssertEqual(x01Score.points, 292)
    }
    ...
    func testHitNineDouble() {
        ...
        XCTAssertEqual(x01Score.ninePoints, 18)
        XCTAssertEqual(x01Score.points, 283)
    }
    ...
    func testHitNineTriple() {
        ...
        XCTAssertEqual(x01Score.ninePoints, 27)
    ...
    func testHitTenSingle() {
        ...
        XCTAssertEqual(x01Score.tenPoints, 10)
        XCTAssertEqual(x01Score.points, 291)
    }
    ...
    func testHitTenDouble() {
        ...
        XCTAssertEqual(x01Score.tenPoints, 20)
    ...
    func testHitTenTriple() {
        ...
        XCTAssertEqual(x01Score.tenPoints, 30)
    ...
    func testHitElevenSingle() {
        ...
        XCTAssertEqual(x01Score.elevenPoints, 11)
    ...
    func testHitElevenDouble() {
        ...
        XCTAssertEqual(x01Score.elevenPoints, 22)
    ...
    func testHitElevenTriple() {
        ...
        XCTAssertEqual(x01Score.elevenPoints, 33)
    ...
    func testHitTwelveSingle() {
        ...
        XCTAssertEqual(x01Score.twelvePoints, 12)
        XCTAssertEqual(x01Score.points, 289)
    }
    ...
    func testHitTwelveDouble() {
        ...
        XCTAssertEqual(x01Score.twelvePoints, 24)
        XCTAssertEqual(x01Score.points, 277)
    }
    ...
    func testHitTwelveTriple() {
        ...
        XCTAssertEqual(x01Score.twelvePoints, 36)
    ...
    func testHitThirteenSingle() {
        ...
        XCTAssertEqual(x01Score.thirteenPoints, 13)
    ...
    func testHitThirteenDouble() {
        ...
        XCTAssertEqual(x01Score.thirteenPoints, 26)
    ...
    func testHitThirteenTriple() {
        ...
        XCTAssertEqual(x01Score.thirteenPoints, 39)
    ...
    func testHitFourteenSingle() {
        ...
        XCTAssertEqual(x01Score.fourteenPoints, 14)
        XCTAssertEqual(x01Score.points, 287)
    }
    ...
    func testHitFourteenDouble() {
        ...
        XCTAssertEqual(x01Score.fourteenPoints, 28)
    ...
    func testHitFourteenTriple() {
        ...
        XCTAssertEqual(x01Score.fourteenPoints, 42)
    ...
    func testHitFifteenSingle() {
        ...
        XCTAssertEqual(x01Score.fifteenPoints, 15)
        XCTAssertEqual(x01Score.points, 286)
    }
    ...
    func testHitFifteenDouble() {
        ...
        XCTAssertEqual(x01Score.fifteenPoints, 30)
        XCTAssertEqual(x01Score.points, 271)
    }
    ...
    func testHitFifteenTriple() {
        ...
        XCTAssertEqual(x01Score.fifteenPoints, 45)
    ...
    func testHitSixteenSingle() {
        ...
        XCTAssertEqual(x01Score.sixteenPoints, 16)
        XCTAssertEqual(x01Score.points, 285)
    }
    ...
    func testHitSixteenDouble() {
        ...
        XCTAssertEqual(x01Score.sixteenPoints, 32)
    ...
    func testHitSixteenTriple() {
        ...
        XCTAssertEqual(x01Score.sixteenPoints, 48)
    ...
    func testHitSeventeenSingle() {
        ...
        XCTAssertEqual(x01Score.seventeenPoints, 17)
    ...
    func testHitSeventeenDouble() {
        ...
        XCTAssertEqual(x01Score.seventeenPoints, 34)
    ...
    func testHitSeventeenTriple() {
        ...
        XCTAssertEqual(x01Score.seventeenPoints, 51)
    ...
    func testHitEighteenSingle() {
        ...
        XCTAssertEqual(x01Score.eighteenPoints, 18)
        XCTAssertEqual(x01Score.points, 283)
    }
    ...
    func testHitEighteenDouble() {
        ...
        XCTAssertEqual(x01Score.eighteenPoints, 36)
        XCTAssertEqual(x01Score.points, 265)
    }
    ...
    func testHitEighteenTriple() {
        ...
        XCTAssertEqual(x01Score.eighteenPoints, 54)
    ...
    func testHitNineteenSingle() {
        ...
        XCTAssertEqual(x01Score.nineteenPoints, 19)
    ...
    func testHitNineteenDouble() {
        ...
        XCTAssertEqual(x01Score.nineteenPoints, 38)
    ...
    func testHitNineteenTriple() {
        ...
        XCTAssertEqual(x01Score.nineteenPoints, 57)
    ...
    func testHitTwentySingle() {
        ...
        XCTAssertEqual(x01Score.twentyPoints, 20)
        XCTAssertEqual(x01Score.points, 281)
    }
    ...
    func testHitTwentyDouble() {
        ...
        XCTAssertEqual(x01Score.twentyPoints, 40)
    ...
    func testHitTwentyTriple() {
        ...
        XCTAssertEqual(x01Score.twentyPoints, 60)
    ...
    func testHitBullSingle() {
        ...
        XCTAssertEqual(x01Score.bullPoints, 25)
    ...
    func testHitBullDouble() {
        ...
        XCTAssertEqual(x01Score.bullPoints, 50)
    ...
    func testUndoEightSingle() {
        ...
        XCTAssertEqual(x01Score.marks.eight, 0)
        XCTAssertEqual(x01Score.eightPoints, 0)
        XCTAssertEqual(x01Score.points, 301)
    }
