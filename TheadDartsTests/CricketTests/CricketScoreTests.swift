...
class CricketScoreTests: XCTestCase {
    ...
    func testDefaultInit() {
        ...
        XCTAssertEqual(cricketScore.fifteenPoints, 0)
        XCTAssertEqual(cricketScore.sixteenPoints, 0)
        XCTAssertEqual(cricketScore.seventeenPoints, 0)
        XCTAssertEqual(cricketScore.eightteenPoints, 0)
        XCTAssertEqual(cricketScore.nineteenPoints, 0)
        XCTAssertEqual(cricketScore.twentyPoints, 0)
        XCTAssertEqual(cricketScore.bullPoints, 0)
    }
    ...
    func testHitFifteen() {
        ...
        XCTAssertEqual(cricketScore.fifteenPoints, 15)
        XCTAssertEqual(cricketScore.sixteenPoints, 0)
        XCTAssertEqual(cricketScore.seventeenPoints, 0)
        XCTAssertEqual(cricketScore.eightteenPoints, 0)
        XCTAssertEqual(cricketScore.nineteenPoints, 0)
    ...
    func testHitFifteenDouble() {
        ...
        XCTAssertEqual(cricketScore.fifteenPoints, 30)
        XCTAssertEqual(cricketScore.sixteenPoints, 0)
        XCTAssertEqual(cricketScore.seventeenPoints, 0)
        XCTAssertEqual(cricketScore.eightteenPoints, 0)
        XCTAssertEqual(cricketScore.nineteenPoints, 0)
    ...
    func testHitFifteenTriple() {
        ...
        XCTAssertEqual(cricketScore.fifteenPoints, 45)
        XCTAssertEqual(cricketScore.sixteenPoints, 0)
        XCTAssertEqual(cricketScore.seventeenPoints, 0)
        XCTAssertEqual(cricketScore.eightteenPoints, 0)
        XCTAssertEqual(cricketScore.nineteenPoints, 0)
    ...
    func testHitSixteen() {
        ...
        XCTAssertEqual(cricketScore.fifteenPoints, 0)
        XCTAssertEqual(cricketScore.sixteenPoints, 16)
        XCTAssertEqual(cricketScore.seventeenPoints, 0)
        XCTAssertEqual(cricketScore.eightteenPoints, 0)
        XCTAssertEqual(cricketScore.nineteenPoints, 0)
        XCTAssertEqual(cricketScore.twentyPoints, 0)
    ...
    func testHitSixteenDouble() {
        ...
        XCTAssertEqual(cricketScore.fifteenPoints, 0)
        XCTAssertEqual(cricketScore.sixteenPoints, 32)
        XCTAssertEqual(cricketScore.seventeenPoints, 0)
        XCTAssertEqual(cricketScore.eightteenPoints, 0)
        XCTAssertEqual(cricketScore.nineteenPoints, 0)
        XCTAssertEqual(cricketScore.twentyPoints, 0)
    ...
    func testHitSixteenTriple() {
        ...
        XCTAssertEqual(cricketScore.fifteenPoints, 0)
        XCTAssertEqual(cricketScore.sixteenPoints, 48)
        XCTAssertEqual(cricketScore.seventeenPoints, 0)
        XCTAssertEqual(cricketScore.eightteenPoints, 0)
        XCTAssertEqual(cricketScore.nineteenPoints, 0)
        XCTAssertEqual(cricketScore.twentyPoints, 0)
    ...
    func testHitSeventeen() {
        ...
        XCTAssertEqual(cricketScore.fifteenPoints, 0)
        XCTAssertEqual(cricketScore.sixteenPoints, 0)
        XCTAssertEqual(cricketScore.seventeenPoints, 17)
        XCTAssertEqual(cricketScore.eightteenPoints, 0)
        XCTAssertEqual(cricketScore.nineteenPoints, 0)
        XCTAssertEqual(cricketScore.twentyPoints, 0)
        XCTAssertEqual(cricketScore.bullPoints, 0)
    ...
    func testHitSeventeenDouble() {
        ...
        XCTAssertEqual(cricketScore.fifteenPoints, 0)
        XCTAssertEqual(cricketScore.sixteenPoints, 0)
        XCTAssertEqual(cricketScore.seventeenPoints, 34)
        XCTAssertEqual(cricketScore.eightteenPoints, 0)
        XCTAssertEqual(cricketScore.nineteenPoints, 0)
        XCTAssertEqual(cricketScore.twentyPoints, 0)
        XCTAssertEqual(cricketScore.bullPoints, 0)
    ...
    func testHitSeventeenTriple() {
        ...
        XCTAssertEqual(cricketScore.fifteenPoints, 0)
        XCTAssertEqual(cricketScore.sixteenPoints, 0)
        XCTAssertEqual(cricketScore.seventeenPoints, 51)
        XCTAssertEqual(cricketScore.eightteenPoints, 0)
        XCTAssertEqual(cricketScore.nineteenPoints, 0)
        XCTAssertEqual(cricketScore.twentyPoints, 0)
        XCTAssertEqual(cricketScore.bullPoints, 0)
    ...
    func testHiteightteen() {
        ...
        XCTAssertEqual(cricketScore.sixteenPoints, 0)
        XCTAssertEqual(cricketScore.seventeenPoints, 0)
        XCTAssertEqual(cricketScore.eightteenPoints, 18)
        XCTAssertEqual(cricketScore.nineteenPoints, 0)
        XCTAssertEqual(cricketScore.twentyPoints, 0)
        XCTAssertEqual(cricketScore.bullPoints, 0)
    }
    func testHiteightteenDouble() {
        ...
        XCTAssertEqual(cricketScore.sixteenPoints, 0)
        XCTAssertEqual(cricketScore.seventeenPoints, 0)
        XCTAssertEqual(cricketScore.eightteenPoints, 36)
        XCTAssertEqual(cricketScore.nineteenPoints, 0)
        XCTAssertEqual(cricketScore.twentyPoints, 0)
        XCTAssertEqual(cricketScore.bullPoints, 0)
    }
    func testHiteightteenTriple() {
        ...
        XCTAssertEqual(cricketScore.sixteenPoints, 0)
        XCTAssertEqual(cricketScore.seventeenPoints, 0)
        XCTAssertEqual(cricketScore.eightteenPoints, 54)
        XCTAssertEqual(cricketScore.nineteenPoints, 0)
        XCTAssertEqual(cricketScore.twentyPoints, 0)
        XCTAssertEqual(cricketScore.bullPoints, 0)
    }
    ...
    func testHitNineteen() {
        ...
        XCTAssertEqual(cricketScore.seventeenPoints, 0)
        XCTAssertEqual(cricketScore.eightteenPoints, 0)
        XCTAssertEqual(cricketScore.nineteenPoints, 19)
        XCTAssertEqual(cricketScore.twentyPoints, 0)
        XCTAssertEqual(cricketScore.bullPoints, 0)
    }
    func testHitNineteenDouble() {
        ...
        XCTAssertEqual(cricketScore.seventeenPoints, 0)
        XCTAssertEqual(cricketScore.eightteenPoints, 0)
        XCTAssertEqual(cricketScore.nineteenPoints, 38)
        XCTAssertEqual(cricketScore.twentyPoints, 0)
        XCTAssertEqual(cricketScore.bullPoints, 0)
    }
    func testHitNineteenTriple() {
        ...
        XCTAssertEqual(cricketScore.seventeenPoints, 0)
        XCTAssertEqual(cricketScore.eightteenPoints, 0)
        XCTAssertEqual(cricketScore.nineteenPoints, 57)
        XCTAssertEqual(cricketScore.twentyPoints, 0)
        XCTAssertEqual(cricketScore.bullPoints, 0)
    }
    ...
    func testHitTwenty() {
        ...
        XCTAssertEqual(cricketScore.eightteenPoints, 0)
        XCTAssertEqual(cricketScore.nineteenPoints, 0)
        XCTAssertEqual(cricketScore.twentyPoints, 20)
        XCTAssertEqual(cricketScore.bullPoints, 0)
    }
    func testHitTwentyDouble() {
        ...
        XCTAssertEqual(cricketScore.eightteenPoints, 0)
        XCTAssertEqual(cricketScore.nineteenPoints, 0)
        XCTAssertEqual(cricketScore.twentyPoints, 40)
        XCTAssertEqual(cricketScore.bullPoints, 0)
    }
    func testHitTwentyTriple() {
        ...
        XCTAssertEqual(cricketScore.eightteenPoints, 0)
        XCTAssertEqual(cricketScore.nineteenPoints, 0)
        XCTAssertEqual(cricketScore.twentyPoints, 60)
        XCTAssertEqual(cricketScore.bullPoints, 0)
    }
    ...
    func testHitBull() {
        ...
        XCTAssertEqual(cricketScore.nineteenPoints, 0)
        XCTAssertEqual(cricketScore.twentyPoints, 0)
        XCTAssertEqual(cricketScore.bullPoints, 25)
    }
    func testHitBullDouble() {
        ...
        XCTAssertEqual(cricketScore.nineteenPoints, 0)
        XCTAssertEqual(cricketScore.twentyPoints, 0)
        XCTAssertEqual(cricketScore.bullPoints, 50)
    }
